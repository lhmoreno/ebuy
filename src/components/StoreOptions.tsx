function StoreOptions() {
  return (
    <div className="ebuy-container py-3 flex justify-between items-center gap-2 bg-white md:py-4 md:gap-6">
      <form
        className="w-full flex"
        onSubmit={e => e.preventDefault()}
      >
        <button
          className="w-12 flex items-center justify-center bg-purple-500 rounded-l md:w-14"
          type="submit"
        >
          <svg className="w-3.5 md:w-4.5" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <input
          className="w-full px-2 py-1 border-y border-r border-gray-400 rounded-r outline-purple-500 placeholder:text-gray-400 md:text-lg"
          type="text"
      ...
      <button
        className="flex items-center gap-1 text-purple-500 md:text-lg"
        type="button"
      >
        <svg className="h-3 md:h-3.5" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
