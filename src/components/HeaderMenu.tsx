function HeaderMenu() {
  return (
    <div className="container-sm py-3 flex justify-between items-center bg-purple-500">
      <p className="font-rubik font-bold text-white text-xl">
        Ebuy
      </p>
      ...
      <button
        ...
        type="button"
      >
        <svg className="w-5" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
