...
const Home: NextPage = () => {
  ...
  return (
    <Fragment>
      ...
      {/* HEADER */}
      <div className="p-4 flex items-start gap-4 bg-purple-500">
        <button
          type="button"
        >
          <svg
      ...
      {/* SEARCH */}
      <form
        className="px-4 pb-4 flex items-center bg-purple-500"
        onSubmit={handleSearchProduct}
      >
        <input
          className="w-full h-10 pl-2 rounded-l placeholder:gray-400"
          type="text"
          placeholder="Macbook"
        />
        <button
      ...
      {/* ORDER */}
      <div className="px-4 py-2 flex gap-2 bg-gray-200 text-gray-500">
        <svg
          className="w-3.5"
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
      ...
      {/* PRODUCTS */}
      <div className="pt-0.5 flex flex-col gap-0.5 bg-gray-200">
